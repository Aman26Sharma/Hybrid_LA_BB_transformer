# Code was adapted from https://github.com/huggingface/transformers/blob/main/src/transformers/models/big_bird/modeling_big_bird.py
# Hugging Face. (2023). transformers/src/transformers/models/big_bird/modeling_big_bird.py. GitHub. 
# https://github.com/huggingface/transformers/blob/main/src/transformers/models/big_bird/modeling_big_bird.py
